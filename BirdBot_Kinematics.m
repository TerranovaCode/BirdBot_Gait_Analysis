...
xE=-l6*sin(q1(t));
yE=l6*cos(q1(t));
x5=xE-a5*sin(q1(t)-delta);
y5=yE+a5*cos(q1(t)-delta);

xB=xE-(l5-BtoD)*sin(q1(t)-delta);
yB=yE+(l5-BtoD)*cos(q1(t)-delta);
xD=xE-(l5)*sin(q1(t)-delta);
yD=yE+(l5)*cos(q1(t)-delta);
