...
legend('u1','u2')
exportgraphics(MotorTourqueGraph,"SpringlessMotorTorque.png")
%U is the tourqe 
%% Angles
%q2(t)=-q2(t)
Theta6=q1;
...
axis equal
exportgraphics(TrunkPostions,"SpringlessTrunkPostions.png")
%% Figure 4
...
exportgraphics(xHandyHbyTime,"xH and yH by time springless.png")
